<?= $this->extend('main/template/layout'); ?>
...
<main class="main">
    ...
    <section id="hero" class="hero section dark-background">
        ...
        <img src="assets/img/IMG-20210905-WA0058.jpg" alt="" data-aos="fade-in" class="">

        <div class="container" data-aos="fade-up" data-aos-delay="100">
            <h2>Bayu Novandrie Saputra</h2>
            <p>I'm <span class="typed" data-typed-items="Backend Developer, Freelancer"></span><span
    ...
    <section id="about" class="about section">
        ...
        <div class="container" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="row gy-4 justify-content-center">
                <div class="col-lg-4">
                    <img src="assets/img/1670935145350.jfif" class="img-fluid" alt="" style="width:100%">
                </div>
